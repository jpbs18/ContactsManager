...
namespace CrudExample.Filters.ResourceFilters
{
    public class FeatureDisabledResourceFilter : IAsyncResourceFilter
    {
        ...
        {
            _logger.LogInformation("{FilterName}.{MethodName} - before next", nameof(FeatureDisabledResourceFilter), nameof(OnResourceExecutionAsync));
            ...
            _logger.LogInformation("{FilterName}.{MethodName} - after next", nameof(FeatureDisabledResourceFilter), nameof(OnResourceExecutionAsync));
        }
    }
}
